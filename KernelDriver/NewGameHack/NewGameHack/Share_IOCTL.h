...
#define IOCTL_INIT \
	CTL_CODE(FILE_DEVICE_UNKNOWN, 0x1550, METHOD_BUFFERED, FILE_ANY_ACCESS) // 초기화 통신
...
#define IOCTL_POINTERSCAN \
	CTL_CODE(FILE_DEVICE_UNKNOWN, 0x1658, METHOD_BUFFERED, FILE_ANY_ACCESS) // Pointer SCAN
