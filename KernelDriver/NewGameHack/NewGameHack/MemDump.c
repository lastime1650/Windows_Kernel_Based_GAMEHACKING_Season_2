...
)
{
	...
	RtlZeroMemory(&output, sizeof(MemDumpOutput));


	if (is_with_page_dump) {
		
		/*

			GET PAGE informations
				---> When "is_with_page_dump" is True 
				MemDumpOutput(output).Dumped_PAGE_BasedAddress will invalid a virtualaddress in the Requester Process
